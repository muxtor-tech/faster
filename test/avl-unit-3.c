...
int main() {
    ...
    printf("Average removal time of %u items over %u deletion attempts: %f useconds\n", removal, generation/2, avg_rem_time * 1000000);
    ...
    if ((found_counter + removal) == insertions) {
        ...
        printf("Questionable structure of AVL Tree (%u inserted, %u found, %u removed, %u nodes)\n",
